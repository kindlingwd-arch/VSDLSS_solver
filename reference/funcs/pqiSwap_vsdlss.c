...
/* name: pqiSwap_vsdlss  addr: 00a0cc80  size: 2f */
#include "vsdlss_ref.h"

/* signature: void pqiSwap_vsdlss(int param_1,int param_2,long param_3); */

void pqiSwap_vsdlss(int param_1,int param_2,long param_3)
