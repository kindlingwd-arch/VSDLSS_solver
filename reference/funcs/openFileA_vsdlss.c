...
/* name: openFileA_vsdlss  addr: 009f3820  size: b5 */
#include "vsdlss_ref.h"

/* signature: FILE * openFileA_vsdlss(int param_1); */

FILE * openFileA_vsdlss(int param_1)

{
  ...
  if (pFVar1 == (FILE *)0x0) {
    nrerror_vsdlss(0xe,"fmanager.c",0x11d,__filename,"append");
  }
