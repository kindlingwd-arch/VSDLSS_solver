...
/* name: openFileR_vsdlss  addr: 009f3750  size: b5 */
#include "vsdlss_ref.h"

/* signature: FILE * openFileR_vsdlss(int param_1); */

FILE * openFileR_vsdlss(int param_1)

{
  ...
  if (pFVar1 == (FILE *)0x0) {
    nrerror_vsdlss(0xe,"fmanager.c",0xf8,__filename,"read");
  }
