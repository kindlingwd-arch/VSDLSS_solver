/* driver: zIL_HgKKBOnOLAR_QZy_HqLISBlgXSPAIPP addr=009aec40 size=6c7 */
#include "vsdlss_ref.h"


void zIL_HgKKBOnOLAR_QZy_HqLISBlgXSPAIPP
...

{
  ...
  switch(param_2) {
  default:
    KOBOOLOXSPAIPP(0xf,"triangularsolves.c",0x38f,6,"blockInnerProductBackSolveNI");
    return;
  case 1:
    pdVar1 = (double *)(param_5 + param_1 * 8);
    dVar17 = 0.0;
    if (1 < param_4) {
      dVar17 = 0.0;
      lVar10 = 1;
      do {
        lVar11 = lVar10 * 8;
        pdVar4 = pdVar1 + lVar10;
        lVar10 = lVar10 + 1;
        dVar17 = dVar17 + *(double *)(*(long *)(param_3 + 8) + 8 + lVar11) * *pdVar4;
      } while (lVar10 != param_4);
    }
    *pdVar1 = (*pdVar1 - dVar17) / *(double *)(*(long *)(param_3 + 8) + 8);
    return;
  case 2:
    ...
    if (param_4 < 3) {
      ...
      dVar17 = 0.0;
      do {
        pdVar4 = pdVar1 + lVar11;
        lVar13 = lVar11 * 8;
        lVar12 = lVar11 * 8;
        lVar11 = lVar11 + 1;
        dVar17 = dVar17 + *(double *)(lVar10 + 0x10 + lVar13) * *pdVar4;
        dVar18 = dVar18 + *pdVar4 * *(double *)(*(long *)(param_3 + 0x10) + 8 + lVar12);
      } while (lVar11 != param_4 + -1);
    }
    pdVar4 = (double *)(param_5 + -8 + param_1 * 8);
    dVar18 = (*pdVar1 - dVar18) / *(double *)(*(long *)(param_3 + 0x10) + 8);
    *pdVar1 = dVar18;
    *pdVar4 = ((*pdVar4 - dVar17) - dVar18 * *(double *)(lVar10 + 0x10)) / *(double *)(lVar10 + 8);
    return;
  case 3:
    param_1 = param_1 * 8;
    lVar10 = *(long *)(param_3 + 8);
    lVar11 = *(long *)(param_3 + 0x10);
    pdVar1 = (double *)(param_5 + param_1);
    if (param_4 < 4) {
      dVar19 = 0.0;
      dVar17 = dVar19;
      dVar18 = dVar19;
      ...
      dVar17 = 0.0;
      do {
        dVar20 = pdVar1[lVar13];
        dVar17 = dVar17 + *(double *)(lVar10 + 0x18 + lVar13 * 8) * dVar20;
        lVar12 = lVar13 * 8;
        lVar14 = lVar13 * 8;
        lVar13 = lVar13 + 1;
        dVar18 = dVar18 + *(double *)(lVar11 + 0x10 + lVar12) * dVar20;
        dVar19 = dVar19 + dVar20 * *(double *)(*(long *)(param_3 + 0x18) + 8 + lVar14);
      } while (lVar13 != param_4 + -2);
    }
    pdVar4 = (double *)(param_5 + -8 + param_1);
    dVar19 = (*pdVar1 - dVar19) / *(double *)(*(long *)(param_3 + 0x18) + 8);
    *pdVar1 = dVar19;
    dVar18 = ((*pdVar4 - dVar18) - dVar19 * *(double *)(lVar11 + 0x10)) / *(double *)(lVar11 + 8);
    *pdVar4 = dVar18;
    pdVar4 = (double *)(param_5 + -0x10 + param_1);
  ...
  case 4:
    ...
    if (param_4 < 5) {
      ...
      do {
        ...
        dVar20 = dVar20 + dVar21 * *(double *)(*(long *)(param_3 + 0x20) + 8 + lVar9);
      } while (lVar12 != param_4 + -3);
    }
    pdVar4 = (double *)(param_5 + -8 + param_1);
    pdVar5 = (double *)(param_5 + -0x10 + param_1);
    dVar20 = (*pdVar1 - dVar20) / *(double *)(*(long *)(param_3 + 0x20) + 8);
    *pdVar1 = dVar20;
    ...
    *pdVar5 = dVar18;
    pdVar5 = (double *)(param_5 + -0x18 + param_1);
  ...
  case 5:
    ...
    if (param_4 < 6) {
      ...
      do {
        ...
        dVar21 = dVar21 + dVar16 * *(double *)(*(long *)(param_3 + 0x28) + 8 + lVar2);
      } while (lVar14 != param_4 + -4);
    }
    pdVar4 = (double *)(param_5 + -8 + param_1);
    pdVar5 = (double *)(param_5 + -0x10 + param_1);
    dVar21 = (*pdVar1 - dVar21) / *(double *)(*(long *)(param_3 + 0x28) + 8);
    *pdVar1 = dVar21;
    ...
    *pdVar4 = dVar20;
    ...
    pdVar6 = (double *)(param_5 + -0x18 + param_1);
    pdVar15 = (double *)(param_5 + -0x20 + param_1);
    *pdVar5 = dVar19;
  ...
  case 6:
    ...
    if (param_4 < 7) {
      ...
      do {
        ...
        dVar16 = dVar16 + dVar8 * *(double *)(*(long *)(param_3 + 0x30) + 8 + lVar3);
      } while (lVar9 != param_4 + -5);
    }
    pdVar4 = (double *)(param_5 + -8 + param_1);
    pdVar5 = (double *)(param_5 + -0x10 + param_1);
    dVar16 = (*pdVar1 - dVar16) / *(double *)(*(long *)(param_3 + 0x30) + 8);
    *pdVar1 = dVar16;
    ...
    *pdVar5 = dVar20;
    dVar19 = ((((*pdVar6 - dVar19) - *pdVar1 * *(double *)(lVar13 + 0x20)) -
             ...
             *(double *)(lVar13 + 8);
    pdVar7 = (double *)(param_5 + -0x20 + param_1);
    pdVar15 = (double *)(param_5 + -0x28 + param_1);
    *pdVar6 = dVar19;
